...
class QHTMLSettingsPrivate;

/**
 * Settings for the HTML view.
 */
class KHTML_EXPORT QHTMLSettings
{
public:
     ...
     */
    QHTMLSettings();
    QHTMLSettings(const QHTMLSettings &other);
     ...
     */
    void init(QSettings *config, bool reset = true);

    /**
     * Destructor. Don't delete any instance by yourself.
     */
    virtual ~QHTMLSettings();
    ...
    // these two can be set. Mainly for historical reasons (the method in QHTMLPart exists...)
    ...
    */
    ...
    /** reads from @p config's current group, forcing initialization
      ...
      *     settings.
      */
    void readDomainSettings(const QSettings &config, bool reset,
