...
class LineEditWidget : public QLineEdit, public KHTMLWidget
{
    Q_OBJECT
public:
...
// -------------------------------------------------------------------------
//AFA use QLineEdit to replace KUrlRequester
class FileButtonWidget: public QLineEdit, public KHTMLWidget
{
public:
    FileButtonWidget(QWidget *p): QLineEdit(p)
    {
        m_kwp->setIsRedirected(true);
    }
};
...
public:
    ...
    {
        return static_cast<QWidget *>(m_widget);
    }
...
class ComboBoxWidget : public QComboBox, public KHTMLWidget
{
public:
...
// -------------------------------------------------------------------------
class TextAreaWidget : public QTextEdit, public KHTMLWidget
{
    Q_OBJECT
public:
