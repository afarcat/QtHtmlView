...
#include "html/html_formimpl.h" //AFA
...
void CSSStyleSelector::loadDefaultStyle(const KHTMLSettings *s, DocumentImpl *doc)
{
    ...
    {
        //AFA QFile f(QStandardPaths::locate(QStandardPaths::GenericDataLocation, "kf5/khtml/css/html4.css"));
        QFile f(":/src/css/html4.css");
    ...
    {
        //AFA QFile f(QStandardPaths::locate(QStandardPaths::GenericDataLocation, "kf5/khtml/css/presentational.css"));
        QFile f(":/src/css/presentational.css");
        f.open(QIODevice::ReadOnly);
