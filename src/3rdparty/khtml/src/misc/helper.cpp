...
QColor khtml::colorForCSSValue(int css_value)
{
    ...
    if (!uicol->css_value) {
        ...
        case CSS_VAL_ACTIVECAPTION:
            //AFA return KColorScheme(QPalette::Active, KColorScheme::Window).background(KColorScheme::ActiveBackground).color();
            return qApp->palette().color(QPalette::Active, QPalette::Window);
        case CSS_VAL_CAPTIONTEXT:
            //AFA return KColorScheme(QPalette::Active, KColorScheme::Window).foreground(KColorScheme::ActiveText).color();
        ...
        case CSS_VAL_INACTIVECAPTION:
            //AFA return KColorScheme(QPalette::Inactive, KColorScheme::Window).background().color();
            return qApp->palette().color(QPalette::Inactive, QPalette::Window);
        case CSS_VAL_INACTIVECAPTIONTEXT:
            //AFA return KColorScheme(QPalette::Inactive, KColorScheme::Window).foreground().color();
            return qApp->palette().color(QPalette::Inactive, QPalette::Text);
