...
//AFA #include "JSHTMLAudioElement.h"
//AFA #include "JSHTMLVideoElement.h"
...
//AFA CREATE_WRAPPER_FUNCTION(Audio)
//AFA CREATE_WRAPPER_FUNCTION(Video)
...
JSValue *KJS::getDOMNode(ExecState *exec, DOM::NodeImpl *n)
{
    ...
    case DOM::Node::ELEMENT_NODE:
        switch (n->id()) {
        case ID_AUDIO:
            //AFA ret = createAudioWrapper(exec, n);
            break;
        case ID_VIDEO:
            //AFA ret = createVideoWrapper(exec, n);
            break;
        default:
